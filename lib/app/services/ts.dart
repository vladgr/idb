...
class Ts {
  ...
  static TextStyle text10(Color color, {bool isUnderline: false}) {
    return _text(10, color, isUnderline: isUnderline);
  }
  ...
  static TextStyle text22(Color color, {bool isUnderline: false}) {
    return _text(20, color, isUnderline: isUnderline);
  }

  static TextStyle text24(Color color, {bool isUnderline: false}) {
    return _text(24, color, isUnderline: isUnderline);
  }

  static TextStyle text26(Color color, {bool isUnderline: false}) {
    return _text(26, color, isUnderline: isUnderline);
  }

  static TextStyle text28(Color color, {bool isUnderline: false}) {
    return _text(28, color, isUnderline: isUnderline);
  }

  static TextStyle text30(Color color, {bool isUnderline: false}) {
    return _text(30, color, isUnderline: isUnderline);
  }

  static TextStyle text32(Color color, {bool isUnderline: false}) {
    return _text(32, color, isUnderline: isUnderline);
  }

  static TextStyle text50(Color color, {bool isUnderline: false}) {
    return _text(50, color, isUnderline: isUnderline);
  }
